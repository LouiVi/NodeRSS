...
ide.AddModule( "jquery" )
ide.AddModule( "bootstrap" )
ide.AddModule( "toastify" )
ide.AddModule( "pako" )
ide.AddModule( "html2canvas" )
ide.AddModule( "image2css" )
ide.AddModule( "qrcode" )
ide.AddModule( "xml2js" )
ide.AddModule( "suncalc" )
ide.AddModule( "loadash" )
ide.AddModule( "chartjs" )
ide.AddModule( "csv" )
ide.AddModule( "excel" )
